...
# Install the latest version of NVIDIA-CUDA, says /usr/local/cuda/
# and append full path of 'nvcc' (cuda compiler) to $PATH in your .bashrc file.
...
$MAKE FC=gfortran CUDA=nvcc ${MAKEOPTS} 2>&1
