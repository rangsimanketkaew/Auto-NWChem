...
source $HOME/intel/impi/2019.5.281/intel64/bin/mpivars.sh intel64 
source $HOME/intel/bin/compilervars.sh intel64
source $HOME/intel/mkl/bin/mklvars.sh intel64
##----------------------- NWChem configuration ------------------------
export NWCHEM_TOP=/home/ubuntu/nwchem-6.8.1-cpu-intel
...
## ---------------------- Intel MPI support ---------------------------
export MPI_ROOT="$HOME/intel/impi/2019.5.281/intel64"
